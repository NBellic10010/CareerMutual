...
In the MVP, cross-domain synthetic roles may express real work inputs through accounting spreadsheets, sales Pipelines, synthetic audio excerpts, or visual direction boards. These resources must be locally synthesized materials with MIME, bytes, SHA-256, and accessible alternative descriptions; third-party remote URLs, real personal information, or unverified uploads must not be disguised as sealed facts.
